...
function getSentimentLabel(pnlPercent, frozenTarget, sentimentIcon, pdtRemaining) {
  ...
  // WEAK · cut threshold not met — negative but not yet in cut territory
  return { label: "WEAK", phrase: "cut threshold not met", color: "#60a5fa", priority: 2 };
}
...
const POS_GRID  = "minmax(38px,0.91fr) 0.7fr 1fr 1fr 90px";
    ...
    <div style={{ fontFamily: "'DM Sans',system-ui,sans-serif", background: BG, color: T1, minHeight: "100vh", maxWidth: 390, margin: "0 auto", position: "relative", paddingBottom: 64 }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .tag-glow{animation:tagGlow 0.9s ease-in-out 0.15s}
      `}</style>
